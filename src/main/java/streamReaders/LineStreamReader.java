...
public class LineStreamReader extends StreamReader {
	...
	/*
	 * Smartmeter Reader Stream Reader, allows the conntection of on going
	 * datastreams from a python connection.,
	 */
	/**
	 * @param aDataInputStream
	 * @param aSmartMeterData
	 */
	public LineStreamReader(DataInputStream aDataInputStream, DataOutputStream aDataOutputStream,
	...
	public Boolean parse() throws IOException {
		...
		super.fOutputStream
				.writeBytes("Java Server Worker " + fWorkerID + " sent " + fSmartMeterData.size() + " lines of Data!");
		super.fOutputStream.flush();
		super.fOutputStream.close();
		fLogger.debug("Finished!");
