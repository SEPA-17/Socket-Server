...
public class SmartMeterStreamReaderTest {
	...
	SmartMeterStreamReader fReader;
	...
	public void testDataSend() {
			...
			fInputStream = new ByteArrayInputStream(lTestString.getBytes());
			...
			try {
				...
				fOutputStream = new DataOutputStream(fOutputStream);
				
				
				fTestList = new ArrayList<SmartMeterDataMap>();
				fReader  = new SmartMeterStreamReader(fDataInputStream, fDataOutputStream, fTestList,420);
