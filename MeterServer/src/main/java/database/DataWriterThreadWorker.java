...
/**
 * This class pulls data of the DataQueue, and feeds it to a DataWriter, where the DataWriter decideds how to process this data
...
public class DataWriterThreadWorker extends Thread {
	...
	/**
	 * Create a new DataWriterThreadWorker thread. This is used to pull data off
